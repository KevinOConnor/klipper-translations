...
Este documento descreve os benchmarks do Klipper.

## Benchmarks de microcontroladores

Esta seção descreve o mecanismo usado para gerar os benchmarks de taxa de passo do microcontrolador Klipper.
