...
`Test_resonances அச்சு = <six> வெளியீடு = <அதிர்வுகள், RAW_DATA> [பெயர் = <பெயர்>] [FREQ_START = <MIN_FREQ>] புள்ளி = ஃச், ஒய், z] [input_shapeing = [<0: 1>>]] `: கோரப்பட்ட" அச்சு "க்கான அனைத்து கட்டமைக்கப்பட்ட ஆய்வு புள்ளிகளிலும் அதிர்வு சோதனையை இயக்குகிறது மற்றும் அந்தந்த அச்சுக்கு கட்டமைக்கப்பட்ட முடுக்கமானி சில்லுகளைப் பயன்படுத்தி முடுக்கம் அளவிடுகிறது. "அச்சு" ஃச் அல்லது ஒய் ஆக இருக்கலாம், அல்லது தன்னிச்சையான திசையை `அச்சு = dx, dy` எனக் குறிப்பிடலாம், அங்கு dx மற்றும் dy ஆகியவை திசை திசையன் வரையறுக்கும் புள்ளி எண்களை மிதக்கின்றன (எ.கா.` அச்சு = x`, `அச்சு = y`, அல்லது மூலைவிட்ட திசையை வரையறுக்க `அச்சு = 1, -1`). `அச்சு = dx, dy` மற்றும்` அச்சு = -dx, -dy` சமம் என்பதை நினைவில் கொள்க. `ADXL345_CHIP_NAME` கமாவுடன் பிரிக்கப்பட்ட ஒன்று அல்லது அதற்கு மேற்பட்ட கட்டமைக்கப்பட்ட ADXL345 CHIP ஆக இருக்கலாம், எடுத்துக்காட்டாக` CHIPS = "ADXL345, ADXL345 RPI" `. `ADXL345` என்று பெயரிடப்பட்ட ADXL345 சில்லுகளிலிருந்து தவிர்க்கலாம் என்பதை நினைவில் கொள்க. புள்ளி குறிப்பிடப்பட்டால், அது `[அதிர்வு_டெச்டர்]` இல் கட்டமைக்கப்பட்ட புள்ளி (களை) மேலெழுதும். `உள்ளீடு_சேப்பிங் = 0` அல்லது அமைக்கப்படாவிட்டால் (இயல்புநிலை), அதிர்வு சோதனைக்கு உள்ளீட்டு வடிவமைப்பை முடக்குகிறது, ஏனெனில் இயக்கப்பட்ட உள்ளீட்டு வடிவத்துடன் அதிர்வு சோதனையை இயக்குவது செல்லுபடியாகாது. `வெளியீடு` அளவுரு என்பது கமாவால் பிரிக்கப்பட்ட பட்டியலாகும், இதன் வெளியீடுகள் எழுதப்படும். `RAW_DATA` கோரப்பட்டால், மூல முடுக்கமானி தரவு ஒரு கோப்பு அல்லது தொடர்ச்சியான கோப்புகளில் எழுதப்பட்டுள்ளது . `அதிர்வுகள்` குறிப்பிடப்பட்டால், அதிர்வெண் பதில் கணக்கிடப்படுகிறது (எல்லா ஆய்வு புள்ளிகளிலும்) மற்றும்`/tmp/அதிர்வு_ <inx> _ <aname> .csv` கோப்பில் எழுதப்பட்டுள்ளது. அமைக்கப்படாவிட்டால், வெளியீடு இயல்புநிலையாக `அதிர்வுகளுக்கு`, மற்றும் பெயர் இயல்புநிலை தற்போதைய நேரத்திற்கு" yyyymmdd_hhmmss "வடிவத்தில் உள்ளது.

#### Shaper_calibrate

`Shaper_calibrate [அச்சு = <six>] [பெயர் = <பெயர்>] [freq_start = <min_freq>] [freq_end = <ax_freq>] [hz_per_sec = <hz_per_sec>] [chips = <adxl345_chip_namemolothen = max_namem>] ; `Max_smoothing` அமைக்கப்படவில்லை என்றால், அதன் மதிப்பு` [அதிர்வு_டெச்டர்] `பிரிவில் இருந்து எடுக்கப்படுகிறது, இயல்புநிலை அமைக்கப்படாதது. இந்த அம்சத்தைப் பயன்படுத்துவது குறித்த கூடுதல் தகவலுக்கு அளவீட்டு அதிர்வு வழிகாட்டியின் [அதிகபட்ச மென்மையான] (அளவீட்டு_ரெசோனன்ச். ட்யூனிங்கின் முடிவுகள் கன்சோலுக்கு அச்சிடப்படுகின்றன, மேலும் அதிர்வெண் பதில்கள் மற்றும் வெவ்வேறு உள்ளீட்டு சேப்பர்ச் மதிப்புகள் ஒரு காபிம கோப்பு (கள்) `/TMP/அளவுத்திருத்த_டேட்டா_ <inx> _ <amen> .csv` க்கு எழுதப்பட்டுள்ளன. குறிப்பிடப்படாவிட்டால், பெயர் "YYYYMMDD_HHMMS" வடிவத்தில் தற்போதைய நேரத்திற்கு இயல்புநிலை. பரிந்துரைக்கப்பட்ட உள்ளீட்டு சேப்பர் அளவுருக்கள் `Save_config` கட்டளையை வழங்குவதன் மூலம் கட்டமைப்பில் தொடரலாம், மேலும்` [INPUT_SHAPER] `முன்பு ஏற்கனவே இயக்கப்பட்டிருந்தால், இந்த அளவுருக்கள் உடனடியாக நடைமுறைக்கு வரும்.
...
`Z_tilt_adjust [கிடைமட்ட_மோவ்_இச் = <மதிப்பு>] [<probe_parameter> = <மதிப்பு>]`: இந்த கட்டளை கட்டமைப்பில் குறிப்பிடப்பட்டுள்ள புள்ளிகளை ஆராய்ந்து பின்னர் ஒவ்வொரு சட் ச்டெப்பரிலும் சுயாதீனமான மாற்றங்களைச் செய்யும். விருப்ப ஆய்வு அளவுருக்கள் குறித்த விவரங்களுக்கு ஆய்வு கட்டளையைப் பார்க்கவும். விருப்பமான `கிடைமட்ட_மோவ்_செச்` மதிப்பு கட்டமைப்பு கோப்பில் குறிப்பிடப்பட்டுள்ள` கிடைமட்ட_மோவ்_செச்` விருப்பத்தை மீறுகிறது.
